...
class __TwigTemplate_9bc181541ca95d253e187a7766f4f2bb549db36a5de31c6d1dd83f746cc4dc91 extends Twig_Template
{
...
";
    ...
    public function block_genemu_jquerydate_javascript_prototype($context, array $blocks = array())
    {
        ...
        if (($this->getContext($context, "widget") != "single_text")) {
            // line 114
            echo "            var \$year = \$('#";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "year"), "vars"), "id"), "html", null, true);
            echo "');
            var \$month = \$('#";
            // line 115
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "month"), "vars"), "id"), "html", null, true);
            echo "');
            var \$day = \$('#";
            // line 116
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "day"), "vars"), "id"), "html", null, true);
            echo "');
...
";
    ...
    public function block_genemu_jquerytokeninput_javascript($context, array $blocks = array())
    {
        ...
        if ($this->getContext($context, "route_name")) {
            // line 231
            echo "                '";
            echo $this->env->getExtension('routing')->getPath($this->getContext($context, "route_name"));
            echo "'
            ";
        } else {
            // line 233
            ...
            echo "                ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "choices"));
            foreach ($context['_seq'] as $context["_key"] => $context["choice"]) {
                // line 235
                echo "                    ";
                $context["sourceChoices"] = twig_array_merge($this->getContext($context, "sourceChoices"), array(0 => array("value" => $this->getAttribute($this->getContext($context, "choice"), "value"), "label" => $this->getAttribute($this->getContext($context, "choice"), "label"))));
                // line 236
                echo "                ";
            }
            $_parent = $context['_parent'];
            ...
            // line 237
            echo "                ";
            echo twig_jsonencode_filter($this->getContext($context, "sourceChoices"));
            echo "
            ";
        }
        // line 238
...
";
    ...
    public function block_genemu_jqueryautocompleter_javascript($context, array $blocks = array())
    {
        ...
        echo "
            ...
            ";
        // line 293
        if ($this->getContext($context, "free_values")) {
            // line 294
...
";
    ...
    public function block_genemu_jqueryautocomplete_javascript($context, array $blocks = array())
    {
        ...
        if ($this->getContext($context, "route_name")) {
            ...
            // line 332
            echo "                \$configs.source = ";
            echo twig_jsonencode_filter($this->getContext($context, "suggestions"));
            echo ";
            ";
        }
        // line 334
        echo "
            ...
            ";
        // line 337
        if (($this->getAttribute($this->getContext($context, "configs", true), "minLength", array(), "any", true, true) && (0 == $this->getAttribute($this->getContext($context, "configs"), "minLength")))) {
            // line 338
...
";
    ...
    public function block_genemu_jquerychosen_javascript_prototype($context, array $blocks = array())
    {
        ...
        echo "                \$field.chosen({
                    no_results_text: \"";
        // line 355
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($this->getContext($context, "no_results_text"), array(), $this->getContext($context, "translation_domain")), "html", null, true);
        echo "\",
        ...
        // line 357
        echo twig_escape_filter($this->env, $this->getContext($context, "disable_search_threshold"), "html", null, true);
        echo "
                });
            ";
    }
    ...
    public function block_genemu_jquerygeolocation_javascript($context, array $blocks = array())
    {
        ...
        if (($this->getContext($context, "map") === true)) {
            // line 369
            echo "        ";
            $context["elements"] = twig_array_merge($this->getContext($context, "elements"), array("map" => (("#" . $this->getContext($context, "id")) . "_map")));
            // line 370
            echo "    ";
        }
        // line 371
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, "form", true), "latitude", array(), "any", true, true)) {
            // line 373
            echo "        ";
            $context["elements"] = twig_array_merge($this->getContext($context, "elements"), array("lat" => ("#" . $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "latitude"), "vars"), "id"))));
            // line 374
            echo "    ";
        }
        // line 375
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, "form", true), "longitude", array(), "any", true, true)) {
            // line 377
            echo "        ";
            $context["elements"] = twig_array_merge($this->getContext($context, "elements"), array("lng" => ("#" . $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "longitude"), "vars"), "id"))));
            // line 378
            echo "    ";
        }
        // line 379
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, "form", true), "locality", array(), "any", true, true)) {
            // line 381
            echo "        ";
            $context["elements"] = twig_array_merge($this->getContext($context, "elements"), array("locality" => ("#" . $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "locality"), "vars"), "id"))));
            // line 382
            echo "    ";
        }
        // line 383
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, "form", true), "country", array(), "any", true, true)) {
            // line 385
            echo "        ";
            $context["elements"] = twig_array_merge($this->getContext($context, "elements"), array("country" => ("#" . $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "country"), "vars"), "id"))));
            // line 386
            echo "    ";
        }
        // line 387
    ...
    ";
        // line 389
        echo "    ";
        if ((twig_length_filter($this->env, $this->getContext($context, "elements")) > 0)) {
            // line 390
            echo "        ";
            $context["configs"] = twig_array_merge($this->getContext($context, "configs"), array("elements" => $this->getContext($context, "elements")));
            // line 391
            echo "    ";
        }
        // line 392
    ...
    <script type=\"text/javascript\">
        jQuery(document).ready(function(\$) {
            \$field = \$('#";
        // line 395
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "form"), "address"), "vars"), "id"), "html", null, true);
        echo "');
...
";
    ...
    public function block_genemu_jqueryfile_javascript_prototype($context, array $blocks = array())
    {
        ...
        var \$configs = \$.extend(";
        // line 420
        echo twig_jsonencode_filter(twig_array_merge($this->getContext($context, "configs"), array("swf" => $this->env->getExtension('assets')->getAssetUrl($this->getAttribute($this->getContext($context, "configs"), "swf")), "cancelImg" => $this->env->getExtension('assets')->getAssetUrl($this->getAttribute($this->getContext($context, "configs"), "cancelImg")), "uploader" => $this->env->getExtension('routing')->getPath($this->getAttribute($this->getContext($context, "configs"), "script")), "queueID" => ($this->getContext($context, "id") . "_queue"))));
        // line 425
        echo ", {
    ...
    public function block_genemu_jqueryimage_javascript_prototype($context, array $blocks = array())
    {
        ...
        var createCrop = function (data) {
            ...
            \$(\$img).load(function() {
                ";
        // line 548
        $context["widthMax"] = (($this->getAttribute($this->getContext($context, "data", true), "thumbnail", array(), "any", true, true)) ? ($this->getAttribute($this->getAttribute($this->getContext($context, "data"), "thumbnail"), "width")) : (500));
        // line 549
        echo "
