...
class __TwigTemplate_40ec79e3c532db4dd4efca12c60dc3fb4c1149f124547100694fb80b0048c74c extends Twig_Template
{
...
";
    ...
    ";
            ...
            ";
            // line 26
            echo strtr($this->getContext($context, "date_pattern"), array("{{ year }}" =>             // line 27
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "year"), 'widget'), "{{ month }}" =>             // line 28
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "month"), 'widget'), "{{ day }}" =>             // line 29
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "day"), 'widget')));
            ...
            ";
            // line 32
            $context["attr"] = twig_array_merge(array("size" => 10), $this->getContext($context, "attr"));
            // line 33
            echo "            ";
...
";
    ...
    public function block_genemu_jquerychosen_widget($context, array $blocks = array())
    {
        ...
        // line 62
        echo "    ";
        $context["attr"] = twig_array_merge(array("data-placeholder" => $this->getContext($context, "empty_value"), "class" => "chzn-select"), $this->getContext($context, "attr"));
        // line 66
        echo "    ";
